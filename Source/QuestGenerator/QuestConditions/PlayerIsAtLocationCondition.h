...
#include "PlayerIsAtLocationCondition.generated.h"

/**
 * 
 */
UCLASS(BlueprintType, Blueprintable)
class QUESTGENERATOR_API UPlayerIsAtLocationCondition : public UQuestCondition
{
	GENERATED_BODY()
public:
	...
	virtual uint32 GenerateStateId() const override;
